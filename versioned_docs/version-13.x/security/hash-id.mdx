...
whenever you need to return an ID (mainly from [transformers](../components/main-components/transformers.mdx))
...
```
Now you need to tell your API to [decode the ID](../components/main-components/requests.md#hash-id-decoding) for you.
