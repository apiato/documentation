...
<div style={{ margin: '2rem 0' }}>
  <img src="/img/apiato.png" alt="Apiato" width="100%" style={{ borderRadius: '8px' }} />
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', justifyContent: 'left', alignItems: 'left' }}>
  ...
  <a href="http://laradock.io/" target="_blank">
    <img src="https://raw.githubusercontent.com/laradock/laradock/master/DOCUMENTATION/static/img/laradock/laradock-icon.png" height="115" alt="Laradock: Full PHP development environment on Docker." />
  </a>
