...
<a href="https://sistava.com/?utm_source=docs_apiato&utm_medium=sponsor&utm_campaign=landing_page_content" target="_blank" style={{ marginRight: '4em' }}>
...
<div style={{ display: 'flex', flexWrap: 'nowrap', gap: '15px', justifyContent: 'left', alignItems: 'center' }}>
  <a href="https://sista.ai/?utm_source=docs_apiato&utm_medium=sponsor&utm_campaign=landing_page_content" target="_blank" style={{ flexShrink: 0 }}>
    <img src="/sponsors/sista-ai-icon-gradient-purple-orange.png" height="90px" alt="Sista AI - AI Workforce platform." />
  </a>

  <iframe
    src="https://opencollective.com/apiato/tiers/silver-sponsors.svg?avatarHeight=90&width=700&format=svg&button=false&background=#171923"
    width="700"
    height="110"
