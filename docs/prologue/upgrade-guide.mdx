...
TODO: extract this doc to the legacy bridge repo and link the repo here. Also update the referenced class namespaces.
...
require
  ...
  - `apiato/localization` to `x` (if installed) TODO
  - `apiato/social-auth` to `x` (if installed) TODO
