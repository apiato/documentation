...
## Naming Conventions For [Routes](../components/main-components/routes.mdx) & [Actions](../components/main-components/actions.md) {#naming-conventions-for-routes-and-actions}
