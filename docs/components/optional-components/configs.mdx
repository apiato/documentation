...
to load all config files in the `app/Containers/{Section}/{Container}/Configs` and `app/Ship/Configs` directories.

If the default configuration does not suit your needs, you can customize it
via the [Apiato Configuration](../../framework-features/advance-configuration.mdx#configs) class.
