...
Read [**Porto SAP Documentation (#Views)**](https://mahmoudz.github.io/Porto/docs/category/main-components).
...
you can customize it via the [Apiato Configuration](../../digging-deeper/advance-configuration.mdx#views) class.
...
via the [Apiato Configuration](../../digging-deeper/advance-configuration.mdx#views) class.
