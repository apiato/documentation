...
```
  apiato:apidoc                    Generate API Documentations with (API-Doc-JS)
  apiato:create:admin              Create a new User with the ADMIN role
  ...
  apiato:generate:event            Create a new Event class and its corresponding Listener
  apiato:generate:exception        Create a new Exception class
  apiato:generate:factory          Create a new Model Factory class for a given Model
  apiato:generate:job              Create a new Job class
  apiato:generate:listener         Create a new Event Listener class
  apiato:generate:mail             Create a new Mail class
  apiato:generate:middleware       Create a new Middleware class
  ...
  apiato:generate:policy           Create a new Policy class
  apiato:generate:provider         Create a Service Provider for a Container
  ...
  apiato:list:actions              List all Actions in the Application
  apiato:list:tasks                List all Tasks in the Application
  apiato:seed-deploy               Seeds your custom deployment data from `app/Ship/Seeders/SeedDeploymentData.php`
  apiato:seed-test                 Seeds your custom testing data from `app/Ship/Seeders/SeedTestingData.php`
  apiato:welcome                   Just saying welcome from a container
```
